...
"""Lifecycle capability registration for runtime V2 plugins."""
...
class PluginLifecycleCapabilities:
    """Capabilities exposed by the plugin lifecycle slice."""

    active_read: PluginActiveRead
    active_write: PluginActiveWrite
    state_read: PluginStateRead
    state_write: PluginStateWrite


def register_plugin_lifecycle_capabilities(
    lifecycle: PluginLifecycleStore,
) -> PluginLifecycleCapabilities:
    """Create plugin lifecycle capabilities."""
