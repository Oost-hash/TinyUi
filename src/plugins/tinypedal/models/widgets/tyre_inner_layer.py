...
@dataclass
class TyreInnerLayer(WidgetConfig):
    name: str = "tyre_inner_layer"

    # groups
    bar: BarConfig = field(default_factory=lambda: BarConfig(horizontal_gap=0, vertical_gap=0))
    font: FontConfig = field(default_factory=FontConfig)
    position: PositionConfig = field(default_factory=lambda: PositionConfig(position_x=249, position_y=563))
    ...
    inner_layer: CellConfig = field(default_factory=lambda: CellConfig(id='inner_layer', font_color=DARK_INVERT.font_color, bkg_color=DARK_INVERT.bkg_color))
    ...
    def to_flat(self) -> Dict[str, Any]:
        ...
        result.update(self.inner_layer.to_flat())
    ...
    @classmethod
    def from_flat(cls, data: Dict[str, Any]) -> "TyreInnerLayer":
        obj = cls()
        ...
        obj.inner_layer = CellConfig.from_flat(data, 'inner_layer')
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result["inner_layer"] = self.inner_layer.to_dict()
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "TyreInnerLayer":
        obj = cls()
        for key in ("enable", "update_interval", "opacity",
                    "bar_gap", "bar_padding", "layout", "bkg_color"):
            if key in data:
        ...
        obj.inner_layer = CellConfig.from_dict(data.get("inner_layer", {}), 'inner_layer')
