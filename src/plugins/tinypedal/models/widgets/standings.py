...
from ..colors import AMBER, CLASS_POSITION, CYAN, FASTEST, GAIN, GARAGE, LIME, LIME_DARK, LOSS, ORANGE, ORANGE_DARK, PENALTY, PIT, PIT_REQUEST, PLAYER, PLAYER_FASTEST, PLAYER_HIGHLIGHT, PLAYER_NAME, READING, RED, SUBTLE, TABLE_DIM, TABLE_HEADER, TABLE_ROW, WHITE_ON_LIGHT, YELLOW_FLAG


@dataclass
class Standings(WidgetConfig):
    name: str = "standings"
    ...
    delta_laptime: CellConfig = field(default_factory=lambda: CellConfig(id='delta_laptime', font_color=READING.font_color, bkg_color=READING.bkg_color, column_index=18))
    ...
    player_delta_laptime: CellConfig = field(default_factory=lambda: CellConfig(id='player_delta_laptime', font_color=PLAYER.font_color, bkg_color=PLAYER.bkg_color))
    ...
    player_time_gap: CellConfig = field(default_factory=lambda: CellConfig(id='player_time_gap', font_color=PLAYER_HIGHLIGHT.font_color, bkg_color=PLAYER_HIGHLIGHT.bkg_color))
    player_time_interval: CellConfig = field(default_factory=lambda: CellConfig(id='player_time_interval', font_color=PLAYER_NAME.font_color, bkg_color=PLAYER_NAME.bkg_color))
    ...
    time_gap: CellConfig = field(default_factory=lambda: CellConfig(id='time_gap', font_color=TABLE_HEADER.font_color, bkg_color=TABLE_HEADER.bkg_color))
    time_gap_from_same_class: CellConfig = field(default_factory=lambda: CellConfig(id='time_gap_from_same_class'))
    time_interval: CellConfig = field(default_factory=lambda: CellConfig(id='time_interval'))
    time_interval_from_same_class: CellConfig = field(default_factory=lambda: CellConfig(id='time_interval_from_same_class'))
    ...
    enable_multi_class_split_mode: bool = True
    enable_single_class_exclusive_mode: bool = False
    energy_remaining_decimal_places: int = 0
    garage_status_text: str = 'G'
    max_vehicles_combined_mode: int = 12
    max_vehicles_exclusive_mode: int = 12
    max_vehicles_per_split_others: int = 3
    max_vehicles_per_split_player: int = 7
    max_vehicles_split_mode: int = 50
    min_top_vehicles: int = 3
    number_of_delta_laptime: int = 3
    pit_status_text: str = 'P'
    split_gap: int = 5
    time_gap_decimal_places: int = 1
    time_gap_leader_text: str = 'LDR'
    time_gap_width: int = 4
    time_interval_decimal_places: int = 1
    time_interval_leader_text: str = 'INT'
    time_interval_width: int = 4
    ...
    def to_flat(self) -> Dict[str, Any]:
        ...
        result.update(self.player_delta_laptime.to_flat())
        ...
        result.update(self.player_time_interval.to_flat())
        ...
        result.update(self.time_gap_from_same_class.to_flat())
        result.update(self.time_interval.to_flat())
        result.update(self.time_interval_from_same_class.to_flat())
        ...
        result["enable_multi_class_split_mode"] = self.enable_multi_class_split_mode
        result["enable_single_class_exclusive_mode"] = self.enable_single_class_exclusive_mode
        ...
        result["max_vehicles_combined_mode"] = self.max_vehicles_combined_mode
        result["max_vehicles_exclusive_mode"] = self.max_vehicles_exclusive_mode
        result["max_vehicles_per_split_others"] = self.max_vehicles_per_split_others
        result["max_vehicles_per_split_player"] = self.max_vehicles_per_split_player
        result["max_vehicles_split_mode"] = self.max_vehicles_split_mode
        result["min_top_vehicles"] = self.min_top_vehicles
        result["number_of_delta_laptime"] = self.number_of_delta_laptime
        result["pit_status_text"] = self.pit_status_text
        result["split_gap"] = self.split_gap
        result["time_gap_decimal_places"] = self.time_gap_decimal_places
        result["time_gap_leader_text"] = self.time_gap_leader_text
        result["time_gap_width"] = self.time_gap_width
        result["time_interval_decimal_places"] = self.time_interval_decimal_places
        result["time_interval_leader_text"] = self.time_interval_leader_text
    ...
    @classmethod
    def from_flat(cls, data: Dict[str, Any]) -> "Standings":
        obj = cls()
        ...
        obj.player_delta_laptime = CellConfig.from_flat(data, 'player_delta_laptime')
        ...
        obj.player_time_interval = CellConfig.from_flat(data, 'player_time_interval')
        ...
        obj.time_gap_from_same_class = CellConfig.from_flat(data, 'time_gap_from_same_class')
        obj.time_interval = CellConfig.from_flat(data, 'time_interval')
        obj.time_interval_from_same_class = CellConfig.from_flat(data, 'time_interval_from_same_class')
        ...
        obj.enable_multi_class_split_mode = data.get("enable_multi_class_split_mode", obj.enable_multi_class_split_mode)
        obj.enable_single_class_exclusive_mode = data.get("enable_single_class_exclusive_mode", obj.enable_single_class_exclusive_mode)
        ...
        obj.max_vehicles_combined_mode = data.get("max_vehicles_combined_mode", obj.max_vehicles_combined_mode)
        obj.max_vehicles_exclusive_mode = data.get("max_vehicles_exclusive_mode", obj.max_vehicles_exclusive_mode)
        obj.max_vehicles_per_split_others = data.get("max_vehicles_per_split_others", obj.max_vehicles_per_split_others)
        obj.max_vehicles_per_split_player = data.get("max_vehicles_per_split_player", obj.max_vehicles_per_split_player)
        obj.max_vehicles_split_mode = data.get("max_vehicles_split_mode", obj.max_vehicles_split_mode)
        obj.min_top_vehicles = data.get("min_top_vehicles", obj.min_top_vehicles)
        ...
        obj.split_gap = data.get("split_gap", obj.split_gap)
        obj.time_gap_decimal_places = data.get("time_gap_decimal_places", obj.time_gap_decimal_places)
        obj.time_gap_leader_text = data.get("time_gap_leader_text", obj.time_gap_leader_text)
        ...
        obj.time_interval_leader_text = data.get("time_interval_leader_text", obj.time_interval_leader_text)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result["player_delta_laptime"] = self.player_delta_laptime.to_dict()
        ...
        result["player_time_interval"] = self.player_time_interval.to_dict()
        ...
        result["time_gap_from_same_class"] = self.time_gap_from_same_class.to_dict()
        result["time_interval"] = self.time_interval.to_dict()
        result["time_interval_from_same_class"] = self.time_interval_from_same_class.to_dict()
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Standings":
        ...
        obj.player_delta_laptime = CellConfig.from_dict(data.get("player_delta_laptime", {}), 'player_delta_laptime')
        ...
        obj.player_time_interval = CellConfig.from_dict(data.get("player_time_interval", {}), 'player_time_interval')
        ...
        obj.time_gap_from_same_class = CellConfig.from_dict(data.get("time_gap_from_same_class", {}), 'time_gap_from_same_class')
        obj.time_interval = CellConfig.from_dict(data.get("time_interval", {}), 'time_interval')
        obj.time_interval_from_same_class = CellConfig.from_dict(data.get("time_interval_from_same_class", {}), 'time_interval_from_same_class')
