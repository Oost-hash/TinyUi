...
@dataclass
class TyreWear(WidgetConfig):
    name: str = "tyre_wear"

    # groups
    font: FontConfig = field(default_factory=FontConfig)
    position: PositionConfig = field(default_factory=lambda: PositionConfig(position_x=57, position_y=444))

    # cells
    end_stint_remaining: CellConfig = field(default_factory=lambda: CellConfig(id='end_stint_remaining', font_color=SECONDARY.font_color, bkg_color=SECONDARY.bkg_color, caption_text='end tread', column_index=6))
    ...
    remaining: CellConfig = field(default_factory=lambda: CellConfig(id='remaining', font_color=GREEN.font_color, bkg_color=GREEN.bkg_color, caption_text='tyre wear', column_index=1))
    ...
    def to_flat(self) -> Dict[str, Any]:
        ...
        result.update(self.end_stint_remaining.to_flat())
    ...
    @classmethod
    def from_flat(cls, data: Dict[str, Any]) -> "TyreWear":
        obj = cls()
        ...
        obj.end_stint_remaining = CellConfig.from_flat(data, 'end_stint_remaining')
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result["end_stint_remaining"] = self.end_stint_remaining.to_dict()
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "TyreWear":
        obj = cls()
        for key in ("enable", "update_interval", "opacity",
                    "bar_gap", "bar_padding", "layout", "bkg_color"):
            if key in data:
        ...
        obj.end_stint_remaining = CellConfig.from_dict(data.get("end_stint_remaining", {}), 'end_stint_remaining')
