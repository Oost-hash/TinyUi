...
def build_runtime_v2_qml_properties(runtime: RuntimeV2, ui_result: UIStartupResult) -> dict[str, object]:
    ...
    for item in ui_result.qml_property_plan:
        ...
        properties[item.qml_property] = runtime.capability(item.capability_name, capability_type)
    return properties


def start_runtime_v2_host(
    *,
    app,
    engine,
    runtime: RuntimeV2,
    theme: Theme | None = None,
) -> tuple[RuntimeV2HostResult | None, StartupResult]:
    ...
    try:
        ...
        qml_properties = build_runtime_v2_qml_properties(runtime, ui_result)
        handle = open_window(
            main_window,
            engine=engine,
            app=app,
